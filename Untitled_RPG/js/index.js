...
let coins = 0
let healthPots = 0
const Goblin = {name: "Goblin", strength: 0, defense: 0, constitution: 0, description: 
"Goblins are small, black-hearted humanoids that lair in despoiled dungeons and other dismal settings. Individually weak, they gather in large numbers to torment other creatures."}

const Bandit = {name: "Bandit", strength: 1, defense: 1, constitution: 1, description:
...
const Orc = {name: "Orc", strength: 2, defense: 2, constitution: 2, description:
...
const Troll = {name: "Troll", strength: 3, defense: 3, constitution: 3, description:
...
const Ogre = {name: "Ogre", strength: 4, defense: 4, constitution: 4, description:
...
const Skeleton = {name: "Skeleton", strength: 2, defense: -1, constitution: -1, description:
...
const Zombie = {name: "Zombie", strength: 1, defense: 3, constitution: 3, description: 
...
const Kobold = {name: "Kobold", strength: -1, defense: -1, constitution: -1, description: 
...
const Harpie = {name: "Harpie", strength: 1, defense: 1, constitution: 1, description: 
...
const enemies = [Goblin, Bandit, Orc, Troll, Ogre, Skeleton, Zombie, Kobold, Harpie]
...
let initialize = 0
 ...
 function attack(){
     ...
     y = y - b
     a = a - x
     if(currentEnemy.name == "Harpie" || currentEnemy.name == "Kobold"){
       y = y - b
     }
     result()
     if(countS > 0){
 ...
 function newFight(){
    currentEnemy = enemies[Math.floor((Math.random() *8))]
    x = 0
